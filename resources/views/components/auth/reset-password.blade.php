			...
			<div class="row align-items-center">
				<div class="col-lg-5 offset-lg-4">
					<div class="padding40 rounded-3 shadow-soft border" data-bgcolor="#ffffff">
						...
						<form id="form_register" class="form-border" method="post" action="{{ route('password.store') }}">
							@csrf
							...
							<div class="field-set mb-2">
								<input type="text" class="form-control m-0 @error('email') is-invalid @enderror" id="email" name="email" placeholder="Enter email address" value="{{ old('email') ?? $request->email }}" />
								@error('email')
							...
							<div id="submit" class="mt-2">
								<input type="submit" id="send_message" value="Reset Password" class="btn-main btn-fullwidth rounded-3" />
							</div>
						</form>
